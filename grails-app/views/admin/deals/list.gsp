	...
	<body>
		...
		<div class='gray-bg padt20 padb10 mgt-1 bbtm'>
			<div class='container'>
				<div class='row'>
					<div class='col-sm-6'>
						<h3 class='mgt0'>Hotel Deals <i class="fa fa-angle-double-right lgray"></i> All </h3>
					</div>
					<div class='col-sm-2 text-right col-sm-offset-1'>
						<button class='btn btn-primary btn-sm width120'>Create Deal</button>
					</div>
					<div class='col-sm-3'>
					  ...
					  <table class="table table-bordered table table-striped">
						<thead>
							<tr>
								...
								<th class='fs12' style='background:#efefef;'>Created</th>
								<th class='fs12' style='background:#efefef;'>Name</th>
								<th class='fs12' style='background:#efefef;'>URL</th>
								<th class='fs12' style='background:#efefef;'>Feed</th>
								<th class='fs12' style='background:#efefef;'>Actions</th>
							</tr>
						</thead>
						<tbody>
							<g:render template="/layouts/templates/admin-deal"></g:render>
						</tbody>
					  </table>
					</div>
				</div>
