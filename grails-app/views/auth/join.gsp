			...
			<div class='row'>
				<div class='col-sm-8 col-sm-offset-2'>
					<div class='card-signin pad20'>
						<h3 class='mgt20 text-center text-primary'>Join TheR8.com</h3>
						<div class='row'>
							<div class='col-sm-6'>
							...
							<div class='col-sm-6'>
								...
								<div class='text-center mgt10'>
									<a class='op80'><img src="${resource(dir: 'images', file: 'fb-signup.png')}" style='height: 50px;'></a>
								</div>
							</div>
						</div>
						<div class='row'>
							<div class='col-sm-6 fs12 mcenter mgt20'>
								Have an account already? <a>Click Here</a>
							</div>
						</div>
					</div>
				</div>
